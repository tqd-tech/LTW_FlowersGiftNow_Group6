...
<head>
    ...
    <title>Thêm mã khuyến mãi - Admin</title>
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="code" id="codeInput" class="form-control" 
                           placeholder="VD: SALE20, NEWYEAR2024" required style="text-transform: uppercase;">
                    <div class="form-hint">Mã sẽ tự động chuyển thành chữ in hoa</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="discount_percent" id="discountInput" class="form-control" 
                           min="1" max="100" placeholder="Nhập từ 1 đến 100" required>
                </div>
                ...
                <div class="discount-preview" id="preview" style="display: none;">
                    <div class="code" id="previewCode">CODE</div>
                    <div class="percent">Giảm <span id="previewPercent">0</span>%</div>
                </div>
...
function updatePreview() {
    ...
    if (code || discount) {
        ...
        previewPercent.textContent = discount || '0';
    } else {
